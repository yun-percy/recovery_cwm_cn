ifeq ($(TARGET_CUSTOM_RECOVERY),CWM)
...
ifdef I_AM_KOUSH
RECOVERY_NAME := Lewa OS Recovery
LOCAL_CFLAGS += -DI_AM_KOUSH
else
ifndef RECOVERY_NAME
RECOVERY_NAME := 乐蛙刷机系统
endif
endif

RECOVERY_VERSION := $(RECOVERY_NAME) v2.0.3
...
BUSYBOX_LINKS := $(shell cat vendor/lewa/external/busybox/busybox-minimal.links)
