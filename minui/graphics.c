...
//#include "font_12x24_cn.h"
#include "chinese.h"


#include "minui.h"
 
#if defined(RECOVERY_FORNT_TYPE_SMALL)
#define FORNT_TYPE RECOVERY_FORNT_TYPE_SMALL
#include "font_12x24_cn.h"
#elif defined(RECOVERY_FORNT_TYPE_MIDDEL)
#define FORNT_TYPE RECOVERY_FORNT_TYPE_MIDDEL
#include "font_16x30_cn.h"
#elif defined(RECOVERY_FORNT_TYPE_BIG)
#define FORNT_TYPE RECOVERY_FORNT_TYPE_BIG
